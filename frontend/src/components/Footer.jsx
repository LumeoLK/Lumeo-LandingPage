...
const Footer = ({ handleScroll }) => {
  ...
  const links = [
    ...
    { name: "How It Works", id: "HowItWorks" }, // Changed from href to id
    { name: "Team", id: "Team" },               // Changed from href to id
    { name: "Get In Touch", id: "GetInTouch" }, // Changed from href to id
  ];
